  ...
  const handleSearch = () => {
    if (search.trim() === "") {
      ...
      const filter = Listproduct.filter(
        (pro) => pro.Name.toLowerCase() === search.toLowerCase()
      );
      setStore(filter);
    }
    setSearch("");
        ...
        <div className="modal-content">
          ...
          <div className="modal-details">
            ...
            <div className="Viewproduct__buy">
              <h5>Quantity: </h5>
              <Button className="Viewproduct__minus" onClick={handleNumbeMinus}>
                -
              </Button>
              <input type="text" value={num} readOnly />
              <Button className="Viewproduct__plus" onClick={handleNumbePlus}>
                +
              </Button>
            </div>
