        ...
        <div className="Calculator_Form">
          <div className="Calculator_Food">
            <Form
              className="Food_form"
              layout="vertical"
              onFinish={onFinishFoodCalculator}
            >
                ...
                <div className="form-column">
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: "Please enter the total number of koi fish!",
                      },
                    ]}
                  >
                    <Input
                  ...
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: "Please enter the average weight!",
                      },
                    ]}
                  >
                ...
                <div className="form-column">
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: "Please enter ratio of food!",
                      },
                    ]}
                  >
                  ...
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: "Please enter the amount of food!",
                      },
                    ]}
                  >
          ...
          <div className="Calculator_Fish">
            <Form
              className="Fish_form"
              layout="vertical"
              onFinish={onFinishFishCalculator}
            >
              <div className="Fish_title">Your Fish Calculator</div>
              <Form.Item
                label="Koi Fish name: "
                name="koiName"
                rules={[
                  {
                    required: true,
                    message: "Please enter name of your Koi fish!",
                  },
                ]}
              >
                ...
                <div className="form-column">
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: "Please enter your length of your Koi fish!",
                      },
                    ]}
                  >
                  ...
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: "Please enter weight of your Koi fish!",
                      },
                    ]}
                  >
                ...
                <div className="form-column">
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: "Please enter ratio of food for Koi fish!",
                      },
                    ]}
                  >
                    <Input placeholder="Enter ratio fish food" />
                  </Form.Item>
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message:
                          "Please enter the amount of food for Koi fish!",
                      },
                    ]}
                  >
                    <Input placeholder="Enter amount of food for Koi fish" />
                  </Form.Item>
                </div>
              </div>
          ...
          <div className="Calculator_Salt">
            <Form
              className="Salt_form"
              layout="vertical"
              onFinish={onFinishSaltCalculator}
            >
                ...
                <div className="form-column">
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: "Please enter the amount of salt!",
                      },
                    ]}
                  >
                  ...
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: "Please enter the salt ratio!",
                      },
                    ]}
                  >
                ...
                <div className="form-column">
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: "Please enter the volume of the lake!",
                      },
                    ]}
                  >
